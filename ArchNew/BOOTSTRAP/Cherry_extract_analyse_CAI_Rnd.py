...
dat_with_cai_trop[['assembly_accession','cDNA_rnd','fid','pid','product','protein','status','table','ribosomal','CAI','TrOp']].to_csv(os.path.join(path,"complete_arch_CDS_CAI_DNA_Rnd.dat"),index=False)
