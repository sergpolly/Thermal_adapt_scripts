...
if __name__ == "__main__":
    # PROT_COUNT = 50
    path = "."
    dat = pd.read_csv(os.path.join(path,"complete_arch_CDS.dat"))
    ...
    #
    def do_work(idx):
        # Update the seed !!!!!!!!!! otherwise it's unpredictable ...
        np.random.seed()
        #
        ...
        #
        # DO NOT NEED THAT, WE'LL USE COMPLETELY RANDOM CODON USAGE ...
        ...
        for aa in SynonymousCodons:
            codons_per_aa = len(SynonymousCodons[aa])
            # normalize ...
            codon_weights[aa] = np.true_divide( [1.0,]*codons_per_aa, float(codons_per_aa) )
        #
    ...
    dat_cDNA_rnd.to_csv(os.path.join(path,"complete_arch_CDS_Rnd_Equal.dat"),index=False)
