...
gen_dat = pd.read_csv(os.path.join(path,"complete_arch_CDS_CAI_DNA_Rnd_Equal.dat"))


org_dat = pd.read_csv(os.path.join(path,"proteome_arch.dat"))
...
for idx,topt in env_dat[['assembly_accession','OptimumTemperature']].itertuples(index=False):
    ...
    if cds_cai_dat['TrOp'].notnull().all():
        ...
        stat_dat['GC'].append(org_dat[org_dat.assembly_accession==idx]['GC'])
        stat_dat['ProtLen'].append(org_dat[org_dat.assembly_accession==idx]['ProtLen'])
        #
...
# plt.show()
plt.savefig("IVYWREL_arch_quantile_hist_Eq.png")
...
plt.xlabel("Temp")
plt.xlabel("IVYWREL(BLUE - HIGHLY EXPRESSED)")
# plt.show()
plt.savefig("IVYWREL_arch_dots_compare_Eq.png")
###############
 # plt.show()
...
# plt.show()
plt.savefig("R20_arch_hist_Eq.png")
...
plt.xlabel('GC')
plt.savefig("R20_arch_delta_on_GC_TM_Eq.png")
...
plt.xlabel('GC')
plt.savefig("IVYWREL_arch_delta_on_GC_TM_Eq.png")
...
plt.xlabel('GC:meso vs thermo')
plt.savefig("Akashi_arch_delta_on_GC_TM_Eq.png")
...
plt.ylabel('$R^{4}_{T} - R^{1}_{T}$')
plt.xlabel('GC: trans. opt.-blue')
plt.savefig("R20_arch_delta_on_GC_TO_Eq.png")
# for the real ribosomal calculated CAI only ...
plt.clf()
delta_R20 = cai_stats_quant['q4'] - cai_stats_quant['q1']
plt.plot(cai_stats_quant[cai_stats_quant.TrOp].GC,delta_R20[cai_stats_quant.TrOp],'ro')
...
plt.ylabel('$IVYWREL_{q4} - IVYWREL_{q1}$')
plt.xlabel('GC: trans. opt.-blue')
plt.savefig("IVYWREL_arch_delta_on_GC_TO_Eq.png")
# for the real ribosomal calculated CAI only ...
plt.clf()
delta_R20 = cai_stats_quant['Akashi_q4'] - cai_stats_quant['Akashi_q1']
plt.plot(cai_stats_quant[cai_stats_quant.TrOp].GC,delta_R20[cai_stats_quant.TrOp],'ro')
...
plt.ylabel('$Akashi_{q4} - Akashi_{q1}$')
plt.xlabel('GC: trans. opt.-blue')
plt.savefig("Akashi_arch_delta_on_GC_TO_Eq.png")
...
# plt.show()
plt.savefig("%s_arch_qunatile_trend_Eq.png"%(kkk if kkk!=k1 else 'IVYWREL'))
