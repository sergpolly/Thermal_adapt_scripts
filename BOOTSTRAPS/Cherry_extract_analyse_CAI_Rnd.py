...
dat = pd.read_csv(os.path.join(path,"complete_CDS_Rnd.dat"))
...
dat_with_cai_trop[['GenomicID','cDNA_rnd','fid','pid','product','protein','status','table','ribosomal','CAI','TrOp']].to_csv(os.path.join(path,"complete_CDS_CAI_DNA_Rnd.dat"),index=False)
